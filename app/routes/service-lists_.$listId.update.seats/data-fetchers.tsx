...
const getServiceListUpdateSeatsData = async (listId: string | undefined) => {
  ...
  if (list.status === "preparing") {
    throw redirect(`/service-lists/${service_list_id}/seats`);
  }
...
export { getServiceListUpdateSeatsData };
